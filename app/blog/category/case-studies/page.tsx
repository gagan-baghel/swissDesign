...
export const metadata: Metadata = {
  ...
  description: "In-depth explorations of our design process, challenges, and outcomes across branding, digital, and print projects.",
}
      ...
      <section className="py-16 px-4 md:px-8 container mx-auto border-b border-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl">
            In-depth explorations of our design process, challenges, and outcomes across branding, digital, and print
            projects.
          </p>
        </div>
      </section>
