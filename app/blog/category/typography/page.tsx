...
export const metadata: Metadata = {
  ...
  description: "Discussions on type selection, pairing, hierarchy, and the expressive power of letterforms.",
}

export default function TypographyCategoryPage() {
  const posts = getPostsByCategory("Typography")
      ...
      <section className="py-20 px-4 md:px-8 container mx-auto border-b border-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl max-w-2xl">
            Read our typography-focused articles, from iconic typefaces to practical hierarchy systems for digital and
            editorial design.
          </p>
        </div>
      </section>
